...
impl_load_save!(toml ShortcutSettings, FOLDERS.in_config_dir("shortcut.toml"), "# Documentation is at https://github.com/MRT-Map/stencil2/wiki/Advanced-Topics#settings.shortcuttoml");
